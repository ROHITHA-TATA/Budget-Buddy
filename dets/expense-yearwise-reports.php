...
<body class="dashboard-container">
    ...
    <main class="main-content" style="margin-left: 280px; min-height: 100vh;">
        ...
        <section class="content-card p-4 shadow-lg">
            ...
            <form role="form" method="post" action="expense-yearwise-reports-detailed.php" name="bwdatesreport" class="form-modern">
                <div class="form-group">
                    <label for="year"><i class="fas fa-calendar"></i> Select Year</label>
                    <input class="form-control" type="number" id="year" name="year" min="2000" max="2100" step="1" required placeholder="Enter year (e.g. 2024)">
                </div>
                <div class="form-group">
